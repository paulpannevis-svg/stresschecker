...
def event_report_html(event_code, meting_code):
    ...
    if lang not in ('nl', 'de', 'en'):
        lang = 'nl'
    import event_report as _evr
    # "Terug" op de /view-rapportpagina gaat terug naar het uitslag-scherm met de drie knoppen
    # (Bekijk/print, Nieuwe meting, Volgende deelnemer) van DEZE deelnemer — niet naar het
...
def _vb_group_data(edb, event_id, lang='nl'):
    ...
    if _avg_ri_num is None:
        ...
        _interp = 'strained'
    # "Onbetrouwbaar" voor de rapport-weergave = ECHT onbetrouwbaar (kwaliteit<90 of band
    # 'slecht'), dus NIET de indicatieve metingen (90-94). `unreliable` telt alle niet-betrouwbare
    # (>=95) rijen; de indicatieve daarvan (indicative_cnt) horen niet als onbetrouwbaar geteld.
    _onbetrouwbaar_n = unreliable - indicative_cnt
    return {'parts': parts, 'n': n, 'reliable_n': ri_n, 'unreliable_n': _onbetrouwbaar_n,
            'indicative_n': indicative_cnt, 'incl_indicative_n': ri_n + indicative_cnt,
            'indicative_pct': round(100 * indicative_cnt / n) if n else 0,
            'pct_in_balance': (pct_in_balance if pct_in_balance is not None else '—'),
            'summary_interp_key': _interp,
            'unreliable_pct': round(100 * _onbetrouwbaar_n / n) if n else 0,
...
'nl': {
  ...
  'rel_reliable': 'Betrouwbare metingen', 'rel_incl': 'Inclusief indicatief', 'rel_of': 'van de', 'rel_part': 'deelnemers', 'indic_bar': 'Indicatief',
...
'de': {
  ...
  'rel_reliable': 'Zuverlässige Messungen', 'rel_incl': 'Inklusive indikativ', 'rel_of': 'von', 'rel_part': 'Teilnehmern', 'indic_bar': 'Orientierend',
...
'en': {
  ...
  'rel_reliable': 'Reliable measurements', 'rel_incl': 'Including indicative', 'rel_of': 'of', 'rel_part': 'participants', 'indic_bar': 'Indicative',
...
_DEELN_STR = {
    'nl': {'title': 'Deelnemers', 'back': 'Dashboard', 'h1': 'Deelnemersrapporten',
           ...
           'th_name': 'Naam', 'th_code': 'Meting-code', 'th_ri': 'Relax Index', 'th_zone': 'Zone',
    ...
    'de': {'title': 'Teilnehmer', 'back': 'Dashboard', 'h1': 'Teilnehmerberichte',
           ...
           'th_name': 'Name', 'th_code': 'Messcode', 'th_ri': 'Relax Index', 'th_zone': 'Zone',
    ...
    'en': {'title': 'Participants', 'back': 'Dashboard', 'h1': 'Participant reports',
           ...
           'th_name': 'Name', 'th_code': 'Measurement code', 'th_ri': 'Relax Index', 'th_zone': 'Zone',
...
_VB_DASH_STR = {
    'nl': {'title': 'Dashboard', 'logout': 'Uitloggen', 'cred_avail': 'Credits beschikbaar',
           ...
           'empty': 'Nog geen events. Klik op "Nieuwe event aanmaken".',
           'st_open': 'open', 'st_gesloten': 'gesloten'},
    'de': {'title': 'Dashboard', 'logout': 'Abmelden', 'cred_avail': 'Credits verfügbar',
           ...
           'empty': 'Noch keine Events. Klicken Sie auf „Neues Event erstellen".',
           'st_open': 'offen', 'st_gesloten': 'geschlossen'},
    'en': {'title': 'Dashboard', 'logout': 'Log out', 'cred_avail': 'Credits available',
           ...
           'empty': 'No events yet. Click "Create new event".',
           'st_open': 'open', 'st_gesloten': 'closed'},
}
